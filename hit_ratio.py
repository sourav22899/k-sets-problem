    ...
    try:
        ...
        for alpha in args.alpha_list:
            ...
            for alg in args.algo_list:
                ...
                # import pdb; pdb.set_trace()
                all_algo_regret[args.algo] = total_rewards
                ...
                if alg in all_hit_rates.keys():
                    all_hit_rates[alg].append(all_algo_regret[alg] / args.T_0)
                else:
                    all_hit_rates[alg] = [all_algo_regret[alg] / args.T_0]
            ...
            with open(save_path, 'w') as f:
                ...
                for i, alg in enumerate(all_algo_regret.keys()):
                    f.write(f"{alg}: {all_algo_regret[alg]} | {all_algo_regret[alg] / args.T_0}\n")
